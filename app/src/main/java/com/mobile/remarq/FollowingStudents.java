 ...
 */
public class FollowingStudents extends Fragment
{
    Student auth;
    private List<Student> students=new ArrayList<>();
    private StudentAdapter stadapter;
    private String url="http://remarq-central.890m.com/pull_students_followme.php";
    private static String TAG = FollowingStudents.class.getSimpleName();


    public FollowingStudents() {
    ...
    {
        final View v=inflater.inflate(R.layout.fragment_following_students, container, false);
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener
    {
        ...
        private FollowingStudents.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final FollowingStudents.ClickListener clickListener)
        {
